...
| P5 — Staging/analítica/observabilidad | En curso | [PR #13](https://github.com/rlcuevas14/PULSYR/pull/13): staging por digest, health/Sentry, medición pública y supply-chain; pendiente CI + merge. |
