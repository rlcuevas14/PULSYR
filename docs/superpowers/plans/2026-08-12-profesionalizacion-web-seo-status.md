...
| P6 — Automatización/lanzamiento | En curso | [PR #24](https://github.com/rlcuevas14/PULSYR/pull/24): gates con artefactos, checklist no-deploy y revisión 30/60/90; pendiente CI + merge. |
