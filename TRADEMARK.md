...
The Pulsyr **software** is free and open source under the [MIT License](LICENSE).
The Pulsyr **name and brand** are not.
...
- Use the name in articles, talks, tutorials, and comparisons.
- Keep the marks in place when redistributing the software unmodified.

## You may not, without written permission

- Use "Pulsyr" or a confusingly similar name as the name of your product,
  service, company, or app.
...
This is the same boundary used by Rust, Grafana, and most open-source projects
with a commercial operator: the code stays open so anyone can use it, and the
name stays protected so users always know who built what they are running.

## Questions

Write to **legal@pulsyr.dev**. Permission requests are usually granted for
non-commercial and community use.

---

*Avonlea Systems SpA · RUT 77.890.325-3 · Hamburgo 550, Ñuñoa, Santiago, Chile*
